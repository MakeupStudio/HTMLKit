...
public extension Optional {
    ...
    func cast<T>(to type: T.Type = T.self, or defaultValue: @autoclosure () -> T) -> T? { cast(to: T.self).unwrap(or: defaultValue()) }
    ...
    func unwrap(or defaultValue: @autoclosure () -> Wrapped) -> Wrapped { self ?? defaultValue() }
...
public extension Optional where Wrapped == Bool {
    ...
    func unwrap(or defaultValue: @autoclosure () -> Wrapped = { false }()) -> Wrapped { self ?? defaultValue() }
...
public extension Optional where Wrapped == Data {
    ...
    func unwrap(or defaultValue: @autoclosure () -> Wrapped = { Data() }()) -> Wrapped { self ?? defaultValue() }
...
public extension Optional where Wrapped == Int {
    ...
    /// - Returns: unwrapped value or default if the caller was nil.
    func unwrap(or defaultValue: @autoclosure () -> Wrapped = { Int() }()) -> Wrapped { self ?? defaultValue() }
...
public extension Optional where Wrapped == Float {
    ...
    /// - Returns: unwrapped value or default if the caller was nil.
    func unwrap(or defaultValue: @autoclosure () -> Wrapped = { Float() }()) -> Wrapped { self ?? defaultValue() }
...
public extension Optional where Wrapped == CGFloat {
    ...
    /// - Parameter default: default value to return if the caller is nil. CGFloat() if not specifed.
    /// - Returns: unwrapped value or default if the caller was nil.
    func unwrap(or defaultValue: @autoclosure () -> Wrapped = { CGFloat() }()) -> Wrapped { self ?? defaultValue() }
...
public extension Optional where Wrapped == Double {
    ...
    /// - Returns: unwrapped value or default if the caller was nil.
    func unwrap(or defaultValue: @autoclosure () -> Wrapped = { Double() }()) -> Wrapped { self ?? defaultValue() }
